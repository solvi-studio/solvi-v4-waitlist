...
export function FeatureCard({ title, image, caption, captionColor = "#F4756A", badge, bgColor = "#FFF9E6" , rotation = 0}: FeatureCardProps) {
  return (
    <div className="flex flex-col items-center gap-4 max-w-[220px]">
      ...
      <div className="relative w-[200px] h-[260px] rounded-2xl overflow-hidden flex items-center justify-center rotate-(--rotation)" style={{ backgroundColor: bgColor, "--rotation": `${rotation}deg` } as React.CSSProperties }>
